...
import { Footer, PreviousBtn, NextBtn, ResetBtn, Switcher, FullscreenBtn, FooterItemsWrapper } from '../../styledComponents';
        ...
        <FooterItemsWrapper>
          <ul>
            <li>
              ...
              <IconButton><Icon name="plus-circle" /></IconButton>
            </li>
            <li>
              <IconButton><Icon name="layers" /></IconButton>
            </li>
            <li>
              <IconButton><Icon name="screen-full" /></IconButton>
            </li>
            <li>
